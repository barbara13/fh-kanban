 ...
 *         JTextfield's die der Benutzer ausfüllen MUSS die JTextArea KANN der
 *         Benutzer ausfüllen Die Werte der JTextfield's werden über die Getter
 *         Methoden an den Controller übergeben
 */
public class CardCreateView extends JFrame implements View {
	...
	public JComponent getComponent() {
		...
		comboBoxValue = new JComboBox<String>(new DefaultComboBoxModel<String>(
				new String[] { "Standart", "Expedite", "Fixed Date",
						"Intangible" }));
